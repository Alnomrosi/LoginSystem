...
Dio_PortLevelType M_Dio_en_getPortValue(Dio_PortType PortId)
{
	...
	switch( PortId)
	{
	case DIO_PORTA :Local_Reading =  PINA_REG;break;
	case DIO_PORTB :Local_Reading =  PINB_REG;break;
	case DIO_PORTC :Local_Reading =  PINC_REG;break;
	case DIO_PORTD :Local_Reading =  PIND_REG;break;
	}
